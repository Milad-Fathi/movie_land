...
class FilmRequest(BaseModel):
    ...
    rating: int = Field(gt=0, lt=6 | None)
    cover_link: str = Field(min_length=1 | None)
    trailer_link: str = Field(min_length=1 | None)
    date: str = Field(min_length=1 | None)
    budget: int = Field(gt=0 | None)
    language:str = Field(min_length=1 | None)
    duration: int = Field(gt=0 | None)
    article_link: str = Field(min_length=1 | None)
